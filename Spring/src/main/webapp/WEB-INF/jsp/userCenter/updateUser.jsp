	...
	<body>
		...
		<div class="page">
			...
			<div class="core">
				...
				<% User pageuser = (User)session.getAttribute("user"); %>
				
				<div ><a class="home" href="<%=basePath%>">返回主页</a></div>
				
				<div class="title">更改用户信息</div>
				...
				<table class="mainbox" border = "0">
					    ...
					    <td colspan="2">
						<form>
							<input type ="text" class="textbox" name="username" id="username" path ="username" 
							       value="<%=pageuser.getUsername()%>" readonly="true"/>
						</form>
					    </td> 
					    </tr> 
						
						<form:form action     ="/Spring/userCenter/updateUser"
				           method     ="POST"
				           modelAttribute="user">
					    ...
					    <tr>
						    ...
						    <form:input  type="text" class="textbox" name="firstname" id="firstname" path ="firstname" value="<%=pageuser.getFirstname()%>" />
						    </td>
					    </tr>
					    ...
					    <tr>
						    ...
						    <form:input  type="text" class="textbox" name="lastname" id="lastname" path ="lastname" value="<%=pageuser.getLastname()%>" /></td>
					    </tr>
					    ...
					    <tr>
						    ...
						    <form:input  type="text" class="textbox" name="lastname" id="phone"    path ="phone" value="<%=pageuser.getPhone()%>" />
					    	</td>
					    </tr>
					    ...
					    <tr>
						    ...
						    <form:input  type="text" class="textbox" name="email" id="email" path ="email" value="<%=pageuser.getEmail()%>" />
					    	</td>
					    </tr>
		...
		<script>
			...
			var pswdblur   = function(event) {
				...
				pswdcheck.addEventListener( 'change'   ,     inpswd , false );
